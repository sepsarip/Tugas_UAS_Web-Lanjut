  ...
  <div class="pt-6">
    ...
    <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
      <div class="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
        <img src="https://images.tokopedia.net/img/cache/900/hDjmkQ/2023/12/6/f8b4cb6a-0ff5-446d-b40f-0491c24d6088.jpg" alt="Two each of gray, white, and black shirts laying flat." class="h-full w-full object-cover object-center">
      </div>
      <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img src="https://images.tokopedia.net/img/cache/700/attachment/2020/5/8/158891567823195/158891567823195_e9d92e93-51b1-4073-ab82-39cce6fca139.png" alt="Model wearing plain black basic tee." class="h-full w-full object-cover object-center">
        </div>
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img src="https://images.k24klik.com/product/large/apotek_online_k24klik_201810201001064677_paramex-nyeri-otot.jpeg" alt="Model wearing plain gray basic tee." class="h-full w-full object-cover object-center">
        </div>
      </div>
      <div class="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
        <img src="https://images.tokopedia.net/img/cache/700/VqbcmM/2022/5/25/b63d1dea-9bdd-4dbf-9d56-7e92f22f7fec.jpg" alt="Model wearing plain white basic tee." class="h-full w-full object-cover object-center">
      </div>
    </div>
    ...
    <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
      <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Paramex Nyeri Otot (1 Box/25 Strip)</h1>
      </div>
    ...
    <div class="flex items-center">
        ...
        <span id="price" class="text-lg ml-2 font-bold">Rp42.000,00</span>
    </div>
</div>
    ...
    <button id="buyNowButton" type="submit" class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Beli Sekarang</button>
      ...
      <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
        ...
        <div>
          ...
          <div class="space-y-6">
            <p class="text-base text-gray-900">Meredakan Nyeri dan Peradangan pada Sendi Otot.</p>
          </div>
        </div>
        ...
        <div class="mt-10">
          ...
          <div class="space-y-6">
            <p class="text-sm text-gray-600">
                ...
                <br>Hipersensitif, pasien yang akan atau telah menjalani operasi by-pass jantung, pasien dengan masalah ginjal, hati, asma, urtikaria atau radang/tukak pada lambung maupun usus, penderita demam berdarah karena dapat menginduksi kebocoran kapiler dan gagal jantung.<br>
                <br>DOSIS
                <br>1 tablet, 3 - 4 kali per hari.<br>
                <br>CARA PEMAKAIAN
                ...
                <br>1 Box<br>
                <br>EFEK SAMPING
                <br>Penggunaan jangka lama dalam dosis besar dapat menimbulkan kerusakan hati. Penggunaan pada penderita yang mengkonsumsi alkohol dapat meningkatkan resiko kerusakan fungsi hati.<br>
                <br>PERHATIAN KHUSUS
                <br>Hamil dan menyusui<br>
                <br>CARA PENYIMPANAN
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        buyNowButton.addEventListener('click', function () {
            const itemName = 'Paramex Nyeri Otot (1 Box/25 Strip)';
