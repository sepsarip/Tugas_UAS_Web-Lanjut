  ...
  <div class="pt-6">
    ...
    <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
      <div class="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
        <img src="https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//86/MTA-3502209/bodrex_bodrex-migra-obat-sakit-kepala--1box-25strip-_full02.jpg" alt="Two each of gray, white, and black shirts laying flat." class="h-full w-full object-cover object-center">
      </div>
      <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img src="https://laz-img-sg.alicdn.com/p/b03579e4434c60a44ec735018465114e.jpg" alt="Model wearing plain black basic tee." class="h-full w-full object-cover object-center">
        </div>
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img src="https://lh3.googleusercontent.com/proxy/eNusS0wiNfYcpd_rhMvPF74RQpb-8iwpxNXavudg-F5Q6bRW_4t4Hg7EccwVPI9SvY8zTWSPrtXI_ULYd_33PZX8yzh64mFsIeiJSQmwbfuPG298w05Khg" alt="Model wearing plain gray basic tee." class="h-full w-full object-cover object-center">
        </div>
      </div>
      <div class="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
        <img src="https://images.tokopedia.net/img/cache/900/VqbcmM/2021/5/20/30fab8be-a913-44e3-867d-561426a026c4.jpg" alt="Model wearing plain white basic tee." class="h-full w-full object-cover object-center">
      </div>
    </div>
    ...
    <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
      <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Bodrex Migra 1 Folding Box isi 25 Blister</h1>
      </div>
    ...
    <div class="flex items-center">
        ...
        <span id="price" class="text-lg ml-2 font-bold">Rp65.000,00</span>
    </div>
</div>
        ...
        <div class="mt-2 ml-8">
          ...
          <div class="flex items-center">
            ...
            <a href="#" class="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">25 Ulasan</a>
          </div>
        </div>
      ...
      <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
        ...
        <div>
          ...
          <div class="space-y-6">
            <p class="text-base text-gray-900">BODREX MIGRA merupakan obat dengan kandungan Paracetamol, propyphenazone, caffeine. Obat ini dapat digunakan untuk meredakan sakit kepala pada migraine. Migraine ditandai dengan rasa sakit yang berdenyut di salah satu sisi kepala.</p>
          </div>
        </div>
        ...
        <div class="mt-10">
          ...
          <div class="space-y-6">
            <p class="text-sm text-gray-600">
                <br>KONTRAINDIKASI // JANGAN DIGUNAKAN OLEH
                <br>Gangguan fungsi hati berat<br>
                <br>DOSIS
                <br>Dewasa : 3 kali sehari 1 kaplet atau menurut petunjuk dokter<br>
                <br>CARA PEMAKAIAN
                <br>Diminum sesudah makan<br>
                <br>Komposisi
                <br>Paracetamol 350 mg, Propyphenazone 150 mg, Caffeine 50 mg.<br>
                <br>KEMASAN
                <br>1 Box<br>
                <br>EFEK SAMPING
                <br>Pemakaian obat umumnya memiliki efek samping tertentu dan sesuai dengan masing-masing individu. Jika terjadi efek samping yang berlebih dan berbahaya, harap konsultasikan kepada tenaga medis. Efek samping yang mungkin terjadi dalam penggunaan obat adalah: Penggunaan jangka lama dan dosis besar dapat menyebabkan kerusakan fungsi ginjal. Reaksi hipersensitifitas.<br>
                <br>PERHATIAN KHUSUS
                <br>Hati-hati penggunaan pada penderita porfiria. Bila setelah 5 hari rasa nyeri tidak berkurang, segera hubungi dokter. Penggunaan obat ini pada penderita yang mengkonsumsi alkohol, dapat meningkatkan resiko kerusakan fungsi hati. Hati-hati penggunaan obat ini pada penderita penyakit ginjal.<br>
                <br>CARA PENYIMPANAN
                <br>Sejuk dan Kering<br>
          </div>
        </div>
      </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        buyNowButton.addEventListener('click', function () {
            const itemName = 'Bodrex Migra 1 Folding Box isi 25 Blister';
