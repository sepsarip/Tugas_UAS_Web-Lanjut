  ...
  <div class="pt-6">
    ...
    <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
      <div class="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
        <img src="https://images.tokopedia.net/img/cache/900/hDjmkQ/2023/2/27/f7202682-53be-465a-b9a4-fd23b61b4443.png" alt="Two each of gray, white, and black shirts laying flat." class="h-full w-full object-cover object-center">
      </div>
      <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img src="https://lifepack.id/wp-content/uploads/2020/12/94-1.jpg" alt="Model wearing plain black basic tee." class="h-full w-full object-cover object-center">
        </div>
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img src="https://i-cf65.ch-static.com/content/dam/cf-consumer-healthcare/panadol/id_id/product-images/Desktop_408x300_flu_batuk.png?auto=format" alt="Model wearing plain gray basic tee." class="h-full w-full object-cover object-center">
        </div>
      </div>
      <div class="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
        <img src="https://images.tokopedia.net/img/cache/900/hDjmkQ/2023/11/27/d782c6e3-2151-4416-be8e-7d6d2cf33617.jpg" alt="Model wearing plain white basic tee." class="h-full w-full object-cover object-center">
      </div>
    </div>
    ...
    <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
      <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Panadol Flu & Batuk (10 Kaplet)</h1>
      </div>
    ...
    <div class="flex items-center">
        ...
        <span id="price" class="text-lg ml-2 font-bold">Rp15.500,00</span>
    </div>
</div>
        ...
        <div class="mt-2 ml-8">
          ...
          <div class="flex items-center">
            ...
            <a href="#" class="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">70 Ulasan</a>
          </div>
        </div>
      ...
      <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
        ...
        <div>
          ...
          <div class="space-y-6">
            <p class="text-base text-gray-900">Panadol Flu & Batuk Caplet merupakan obat batuk dan pereda flu dengan kandungan Paracetamol, Phenylephrine HCI, dan Dextromethorphan HBr. Bekerja sebagai analgesik-antipiretik, masal dekongestan, dan antitusif. Obat ini dapat digunakan untuk meredakan gejala flu seperti: demam, sakit kepala, hidung tersumbat dan batuk tidak berdahak.</p>
          </div>
        </div>
        ...
        <div class="mt-10">
          ...
          <div class="space-y-6">
            <p class="text-sm text-gray-600">
                ...
                <br>Penderita hipersensitif terhadap komponen obat ini. Penderita dengan gangguan fungsi hati yang berat, gangguan jantung, dan diabetes mellitus.<br>
                <br>DOSIS
                <br>Dewasa: 1 kaplet 3 kali sehari Jangan melebihi 8 kaplet dalam tiap jangka waktu 24 jam. Jangan diberikan kepada anak-anak di bawah umur 12 tahun, kecuali atas petunjuk dokter.<br>
                <br>CARA PEMAKAIAN
                <br>Diminum sesudah makan<br>
                <br>MANUFAKTUR
                <br>Sterling<br>
                <br>KEMASAN
                <br>1 Strip @ 10 Kaplet<br>
                <br>EFEK SAMPING
                <br>Penggunaan jangka panjang dan dosis besar dapat menyebabkan kerusakan hati. Efek samping lain yaitu tachycardia (jantung berdebar), dyspepsia, nausea, kemerahan pada kulit, depresi pernafasan dan SSP, mengantuk, konstipasi, mual, pusing, gangguan saluran pencernaan, insomnia, gelisah, tremor. Penggunaan jangka panjang dan dosis besar menyebabkan kerusakan hati.<br>
                <br>PERHATIAN KHUSUS
                <br>Awas! Obat keras, bacalah aturan memakainya. Hati- hati penggunaan pada penderita tekanan darah tinggi atau mempunyai potensi tekanan darah tinggi atau stroke, seperti pada penderita dengan berat badan berlebih atau penderita usia lanjut. Bila dalam 3 hari gejala flu tidak berkurang segera hubungi dokter. Hentikan penggunaan obat jika terjadi susah tidur, jantung berdebar, dan pusing. Simpan dalam wadah tertutup rapat, ditempat kering dan dibawah 30 C.<br>
                <br>GOLONGAN
                <br>Obat Bebas Terbatas (Biru)</p>
          </div>
        </div>
      </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        buyNowButton.addEventListener('click', function () {
            const itemName = 'Panadol Flu & Batuk (10 Kaplet)';
