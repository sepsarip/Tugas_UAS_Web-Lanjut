  ...
  <div class="pt-6">
    ...
    <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
      <div class="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
        <img src="https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//74/MTA-12010310/sidomuncul_tolak_angin_cair_plus_honey_sachet_5_ml_isi_12_sachet_full01_b4cyr5vz.jpg" alt="Two each of gray, white, and black shirts laying flat." class="h-full w-full object-cover object-center">
      </div>
      <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img src="https://images.tokopedia.net/img/cache/700/VqbcmM/2022/3/29/2c9f37e4-cb43-4be5-98c9-d111b311921c.jpg" alt="Model wearing plain black basic tee." class="h-full w-full object-cover object-center">
        </div>
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img src="https://images-cdn.ubuy.co.id/6571f7685ed0ac7c942e2739-sido-muncul-tolak-angin-herbal-with.jpg" alt="Model wearing plain gray basic tee." class="h-full w-full object-cover object-center">
        </div>
      </div>
      <div class="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
        <img src="https://images.tokopedia.net/img/cache/900/VqbcmM/2023/11/8/c16a9768-e095-4102-8653-b3cc78915d7b.jpg" alt="Model wearing plain white basic tee." class="h-full w-full object-cover object-center">
      </div>
    </div>
    ...
    <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
      <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Tolak Angin + Honey</h1>
      </div>
    ...
    <div class="flex items-center">
        ...
        <span id="price" class="text-lg ml-2 font-bold">Rp45.000,00</span>
    </div>
</div>
        ...
        <div class="mt-2 ml-8">
          ...
          <div class="flex items-center">
            ...
            <a href="#" class="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">56 Ulasan</a>
          </div>
        </div>
      ...
      <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
        ...
        <div>
          ...
          <div class="space-y-6">
            <p class="text-base text-gray-900">Tolak Angin Cair + Madu Sachet 15ML merupakan obat herbat terstandar yang mengandung kombinasi berbagai herbal alami yang dapat digunakan untuk meringankan gejala masuk angin. Selain itu, tolak angin cair juga dapat membantu meningkatkan daya tahan tubuh.</p>
          </div>
        </div>
        ...
        <div class="mt-10">
          ...
          <div class="space-y-6">
            <p class="text-sm text-gray-600">
                <br>Komposisi :
                <br>Amoni Fructus (kapulaga), Foeniculli Fructus (adas), Isorae Fructus (kayu ules), Myristicae Semen (pala), Burmanni Cortex (kayu manis), Centellae Herba (pegagan), Caryophylli Folium (cengkeh), Parkiae Semen (kedawung), Oryza sativa (beras), Menthae arvensitis Herba (poko), Usneae thallus (kayu angin), Zingiberis Rhizoma(jahe), ekstrak Panax Radix, 70% Mel Depuratum (Madu).<br>
                <br>DOSIS
                <br>Untuk daya tahan tubuh: minum 1 sachet, 2 kali per hari. Selama 7 hari atau lebih. Untuk masuk angin/sakit perut dan diare: minum 1 sachet, 3 sampai 4 kali per hari. Sebelum melakukan perjalanan minum 1 sachet, atau 1-3 sachet pada waktu mabuk perjalanan. Saat kecapaian dan kurang tidur, minum 1 sachet. Untuk mabuk atau saat melakukan perjalanan: minum 1 sachet, 1 kali per hari.<br>
                <br>CARA PEMAKAIAN
                <br>Sesudah makan. Obat dapat langsung diminum atau dapat dicampur dengan air.<br>
                <br>MANUFAKTUR
                <br>Konimex<br>
                <br>KEMASAN
                <br>Box, 5 Sachet @ 15 ml<br>
          </div>
        </div>
      </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        buyNowButton.addEventListener('click', function () {
            const itemName = 'Tolak Angin + Honey';
