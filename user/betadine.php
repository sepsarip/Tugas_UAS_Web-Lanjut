  ...
  <div class="pt-6">
    ...
    <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
      <div class="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
        <img src="https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//1030/betadine_betadine-antiseptic-solution-obat-luka-15ml_full02.jpg" alt="Two each of gray, white, and black shirts laying flat." class="h-full w-full object-cover object-center">
      </div>
      <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img src="https://d2qjkwm11akmwu.cloudfront.net/products/326736_25-8-2021_16-50-52-1665780207.webp" alt="Model wearing plain black basic tee." class="h-full w-full object-cover object-center">
        </div>
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img src="https://assets.klikindomaret.com/products/10000553/10000553_1.jpg" alt="Model wearing plain gray basic tee." class="h-full w-full object-cover object-center">
        </div>
      </div>
      <div class="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
        <img src="https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//100/MTA-32165668/betadine_betadine_solution_30ml_full02.jpg" alt="Model wearing plain white basic tee." class="h-full w-full object-cover object-center">
      </div>
    </div>
    ...
    <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
      <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Betadine Solution 30 ml</h1>
      </div>
    ...
    <div class="flex items-center">
        ...
        <span id="price" class="text-lg ml-2 font-bold">Rp16.000,00</span>
    </div>
</div>
      ...
      <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
        ...
        <div>
          ...
          <div class="space-y-6">
            <p class="text-base text-gray-900">Antiseptik untuk Membunuh Kuman Penyebab Infeksi. Mengandung bahan aktif Povidone-Iodine 10% sebagai agen antimikroba. Bekerja cepat membunuh kuman penyebab infeksi pada luka.</p>
          </div>
        </div>
        ...
        <div class="mt-10">
          ...
          <div class="space-y-6">
            <p class="text-sm text-gray-600">
                ...
                <br>Hipersensitivitas terhadap iodine<br>
                <br>Komposisi :
                <br>Povidone Iodine 10%<br>
                <br>DOSIS
                <br>Dapat digunakan beberapa kali dalam sehari dengan konsentrasi penuh, baik untuk mengoles maupun kompres.<br>
                <br>CARA PEMAKAIAN
                <br>Teteskan pada kulit yang luka atau infeksi.<br>
                <br>KEMASAN
                <br>Dus, Botol @ 30 ml<br>
                <br>Efek Samping
                <br>Iritasi lokal. Hentikan pemakaian apabila terjadi reaksi lokal.<br>
                <br>MANUFAKTUR
                <br>Mundipharma Healthcare Indonesia</p>
          </div>
        </div>
      </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        buyNowButton.addEventListener('click', function () {
            const itemName = 'Betadine Solution 30 ml';
